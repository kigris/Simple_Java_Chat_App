...
public class clientChat {
	public static void main(String[] args) {
		...
		try { // Se intentan abrir los buffers
			...
			// Se crea el hilo de escucha con un buffer de lectura del servidor, para mensajes entrantes
			new ListenThread(new BufferedReader(new InputStreamReader(socket.getInputStream())));
